...
activities = {
    ...
    "Basketball Team": {
        "description": "Join the school basketball team and practice for games",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu", "nina@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim laps, improve techniques, and prepare for swim meets",
        "schedule": "Wednesdays and Fridays, 3:00 PM - 4:30 PM",
        "max_participants": 18,
        "participants": ["linda@mergington.edu", "matt@mergington.edu"]
    },
    "Art Club": {
