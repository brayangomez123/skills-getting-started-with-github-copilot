document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        activityCard.appendChild(createDeleteButtons(name, details.participants));
  ...
  async function handleDeleteParticipant(event) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Refresh activities without reloading page
  ...
  function createDeleteButtons(activityName, participants) {
    // This is a helper - buttons are already included in HTML above
